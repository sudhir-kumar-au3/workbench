...
contextBridge.exposeInMainWorld('api', {
  ...
  repos: {
    ...
    setSetupCommand: (path, command) => ipcRenderer.invoke('repos:setSetupCommand', path, command),
  ...
  workspaces: {
    ...
    createFromPr: (spec) => ipcRenderer.invoke('workspaces:createFromPr', spec),
  ...
  git: {
    ...
    lastCommitMessage: (path) => ipcRenderer.invoke('git:lastCommitMessage', path),
    createPr: (path, opts) => ipcRenderer.invoke('git:createPr', path, opts),
